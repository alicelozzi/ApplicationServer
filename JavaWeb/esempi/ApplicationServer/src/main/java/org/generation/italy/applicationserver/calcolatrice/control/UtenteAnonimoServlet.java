 ...
 */
package org.generation.italy.applicationserver.calcolatrice.control;
...
import org.generation.italy.applicationserver.calcolatrice.model.CalcolatriceModelException;
import org.generation.italy.applicationserver.calcolatrice.model.dao.CalcoloDao;
...
import org.generation.italy.applicationserver.calcolatrice.view.MessaggioView;
import org.generation.italy.applicationserver.calcolatrice.view.RicercaCalcoliView;
...
public class UtenteAnonimoServlet {
	...
	byte[] actionRicercaCalcoliInDataSpecifica(Map<String, String> parameterValueCollection) 
		...
		try {
			...
			throw new CalcolatriceControlException("UtenteAnonimoServlet -> actionRicercaCalcoliInDataSpecifica -> " + "parametri in input assenti!");
		} catch (CalcolatriceModelException ex1) {
			throw new CalcolatriceControlException("UtenteAnonimoServlet -> actionRicercaCalcoliInDataSpecifica -> " + ex1.getMessage());
		}
