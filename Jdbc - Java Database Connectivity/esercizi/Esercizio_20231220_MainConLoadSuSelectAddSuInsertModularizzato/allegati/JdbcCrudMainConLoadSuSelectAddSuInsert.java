...
public class JdbcCrudMainConLoadSuSelectAddSuInsert {
	...
	public static void main(String[] args) {
		...
		try {																	//prova ad eseguire le istruzioni interne al blocco try-catch
			...
			//algoritmo che seleziona il record è trasferito nel metodo loadClienteByPrimaryKey
			Cliente cliente = loadClienteByPrimaryKey(jdbcConnectionToDatabase, "BRNGRD0123456789");
...
//		}
	...
	public 
	static
	Cliente loadClienteByPrimaryKey(Connection jdbcConnectionToDatabase
...
//		String parametroCodiceFiscale = "BRNGRD0123456789"; // imposta il valore del parametro codice fiscale
	 ...
	 */
	//public List<Cliente> loadClienteByNominativo(String nominativo){};
	
	//add => INSERT
	//public void addCliente(Cliente cliente);						// "INSERT INTO cliente (codice_fiscale, nominativo) VALUES (?, ?) ";
